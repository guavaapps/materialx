...
//     }
//
//     static fromStatesheet(statesheet: Statesheet1) {
...
// }
//
// function useComponentStateHandler(statesheet: Statesheet1, state: string, setState: Dispatch<SetStateAction<string>>) {
//     return useMemo(() => {
